...
class ScatterNdAdd {
 public:
  ...
  ScatterNdAdd(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input ref,
             ::tensorflow::ops::Input indices, ::tensorflow::ops::Input
             updates);
  ScatterNdAdd(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input ref,
             ::tensorflow::ops::Input indices, ::tensorflow::ops::Input
             updates, const ScatterNdAdd::Attrs& attrs);
  operator ::tensorflow::ops::Output() const { return output_ref; }
  operator ::tensorflow::ops::Input() const { return output_ref; }
  ::tensorflow::Node* node() const { return output_ref.node(); }
...
class ScatterNdSub {
 public:
  ...
  ScatterNdSub(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input ref,
             ::tensorflow::ops::Input indices, ::tensorflow::ops::Input
             updates);
  ScatterNdSub(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input ref,
             ::tensorflow::ops::Input indices, ::tensorflow::ops::Input
             updates, const ScatterNdSub::Attrs& attrs);
  operator ::tensorflow::ops::Output() const { return output_ref; }
  operator ::tensorflow::ops::Input() const { return output_ref; }
  ::tensorflow::Node* node() const { return output_ref.node(); }
...
class ScatterNdUpdate {
 public:
  ...
  ScatterNdUpdate(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input ref,
                ::tensorflow::ops::Input indices, ::tensorflow::ops::Input
                updates);
  ScatterNdUpdate(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input ref,
                ::tensorflow::ops::Input indices, ::tensorflow::ops::Input
                updates, const ScatterNdUpdate::Attrs& attrs);
  operator ::tensorflow::ops::Output() const { return output_ref; }
  operator ::tensorflow::ops::Input() const { return output_ref; }
  ::tensorflow::Node* node() const { return output_ref.node(); }
