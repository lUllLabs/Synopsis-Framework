...
class Log1p {
 public:
  Log1p(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input x);
  operator ::tensorflow::ops::Output() const { return y; }
  operator ::tensorflow::ops::Input() const { return y; }
  ::tensorflow::Node* node() const { return y.node(); }
...
class RequantizationRange {
 public:
  RequantizationRange(const ::tensorflow::Scope& scope, ::tensorflow::ops::Input
                    input, ::tensorflow::ops::Input input_min,
                    ::tensorflow::ops::Input input_max);
