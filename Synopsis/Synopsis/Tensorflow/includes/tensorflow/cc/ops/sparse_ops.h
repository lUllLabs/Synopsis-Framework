...
class AddManySparseToTensorsMap {
 public:
  ...
  AddManySparseToTensorsMap(const ::tensorflow::Scope& scope,
  ...
  AddManySparseToTensorsMap(const ::tensorflow::Scope& scope,
                          ::tensorflow::ops::Input sparse_indices,
                          ::tensorflow::ops::Input sparse_values,
                          ::tensorflow::ops::Input sparse_shape, const
                          AddManySparseToTensorsMap::Attrs& attrs);
  operator ::tensorflow::ops::Output() const { return sparse_handles; }
  operator ::tensorflow::ops::Input() const { return sparse_handles; }
  ...
  ::tensorflow::ops::Output sparse_handles;
};
...
class AddSparseToTensorsMap {
 public:
  ...
  AddSparseToTensorsMap(const ::tensorflow::Scope& scope,
                      ::tensorflow::ops::Input sparse_indices,
                      ::tensorflow::ops::Input sparse_values,
                      ::tensorflow::ops::Input sparse_shape);
  AddSparseToTensorsMap(const ::tensorflow::Scope& scope,
  ...
  operator ::tensorflow::ops::Output() const { return sparse_handle; }
  operator ::tensorflow::ops::Input() const { return sparse_handle; }
  ...
  ::tensorflow::ops::Output sparse_handle;
};
...
class TakeManySparseFromTensorsMap {
 public:
  ...
  TakeManySparseFromTensorsMap(const ::tensorflow::Scope& scope,
                             ::tensorflow::ops::Input sparse_handles, DataType
                             dtype);
  TakeManySparseFromTensorsMap(const ::tensorflow::Scope& scope,
                             ::tensorflow::ops::Input sparse_handles, DataType
